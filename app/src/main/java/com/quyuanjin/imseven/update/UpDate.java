package com.quyuanjin.imseven.update;
...
import com.quyuanjin.imseven.utils.OkGoUpdateHttpUtil;
...
private Activity activity;
    ...
    public void checkVersion() {
        ...
        String updateURL = "http://www.samuer.top:88/update.json";
        Map<String, String> params = new HashMap<String, String>();

        //  params.put("appKey", "ab55ce55Ac4bcP408cPb8c1Aaeac179c5f6f");
        params.put("appVersion", getLocalVersionName(activity));
    ...
    public void showDiyDialog(UpdateAppBean updateApp, final UpdateAppManager updateAppManager) {
