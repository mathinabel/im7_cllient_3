...
public class Msg {
    ...
    @Generated(hash = 1063898615)
    public Msg(Long id, String sendID, String receiveId, String msg, String msgUUID, String createTime, String localPath, String netPath, int contentType, float recorderTime, String sendSucceedType, String readType, String fanyi) {
        this.id = id;
        this.sendID = sendID;
