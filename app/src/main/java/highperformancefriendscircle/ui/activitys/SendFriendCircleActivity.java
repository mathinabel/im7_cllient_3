...
import highperformancefriendscircle.adapters.GridImageAdapter;
import highperformancefriendscircle.interfaces.listener.DragListener;
import highperformancefriendscircle.manager.FullyGridLayoutManager;
import okhttp3.Call;

import static com.quyuanjin.imseven.MainActivity.userid;


public class SendFriendCircleActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button btnSendFriendCircle;
    private EditText edit_text_circle_friend;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_text_circle_friend = findViewById(R.id.edit_text_circle_friend);
            ...
            if (selectList.size() > 0) {
                ...
                switch (mediaType) {
                    case PictureConfig.TYPE_VIDEO:
                        // 预览视频
                        PictureSelector.create(SendFriendCircleActivity.this)
...
//                        animationStyle.activityPreviewExitAnimation = R.anim.picture_anim_down_out;
        ...
        btnSendFriendCircle = findViewById(R.id.btnSendFriendCircle);

        btnSendFriendCircle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String s = "";
                        if (!"".equals(edit_text_circle_friend.getText().toString())) {
                            s = edit_text_circle_friend.getText().toString();
                        }
                        OkHttpUtils.get()
                                .url(Constant.URL_netty_send_friendCircle + "sendFriedCircle")
                            ...
                            public void onResponse(String response, int id) {
                                if ("ok".equals(response)){
                                    ToastUtils.s(getApplicationContext(),"ok");
                                }
                            }
                        });
            ...
            case PictureConfig.APPLY_STORAGE_PERMISSIONS_CODE:
                ...
                for (int i = 0; i < grantResults.length; i++) {
                    if (grantResults[i] == PackageManager.PERMISSION_GRANTED) {
                        ...
                        Toast.makeText(SendFriendCircleActivity.this,
