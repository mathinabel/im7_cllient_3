...
public class LiveMain extends Activity implements RtmpHandler.RtmpListener,
        SrsRecordHandler.SrsRecordListener, SrsEncodeHandler.SrsEncodeListener {


    private String rtmpUrl = "rtmp://120.79.178.226:1935/live/2";
    private String rtmpUrl1 = "rtmp://120.79.178.226:1935/live/1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PermissionGen.with(LiveMain.this)
                .addRequestCode(100)
                .permissions(
      ...
      //  sp = getSharedPreferences("Yasea", MODE_PRIVATE);
       // rtmpUrl = sp.getString("rtmpUrl", rtmpUrl);
        ...
        btnPublish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (btnPublish.getText().toString().contentEquals("publish")) {
                    rtmpUrl1 = efu.getText().toString();
                  //  SharedPreferences.Editor editor = sp.edit();
                  //  editor.putString("rtmpUrl", rtmpUrl);
                  //  editor.apply();

                    mPublisher.startPublish(rtmpUrl1);
                    mPublisher.startCamera();
        ...
        upVideoView.setVideoPath(rtmpUrl);
